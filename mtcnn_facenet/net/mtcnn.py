...
from mtcnn_facenet.utils import utils
...
class mtcnn():
    def __init__(self):
        self.Pnet = create_Pnet('mtcnn_facenet/model_data/pnet.h5')
        self.Rnet = create_Rnet('mtcnn_facenet/model_data/rnet.h5')
        self.Onet = create_Onet('mtcnn_facenet/model_data/onet.h5')
