...
import mtcnn_facenet.utils.utils as utils
from mtcnn_facenet.net.inception import InceptionResNetV1
from mtcnn_facenet.net.mtcnn import mtcnn
...
def update_face_embeddings():
    ...
    model_path = 'mtcnn_facenet/model_data/facenet_keras.h5'
    ...
    # -----------------------------------------------#
    face_list = os.listdir("mtcnn_facenet/face_dataset")
    known_face_encodings = []
    known_face_names = []
    for face in face_list:
        name = face.split(".")[0]
        img = cv2.imread("mtcnn_facenet/face_dataset/" + face)
        ...
        with open("face_embeddings_name/face_date.pkl", "wb") as f:
